export class StringMath {
   ...
   */
     ...
     * @param rowString 
     */
    static getMinEditDistance(columnString: string, rowString: string) {
    ...
    static getUniquePermutations(string: string) {
        ...
        for (let i = 1; i < string.length; i++) {
            ...
            const currentLevelPermutations: Set<string> = new Set();
    ...
    static getUniquePermutations2(string: string) {
        ...
        function getPermutationsRecursively(string: string, possibleChars: string[]) {
