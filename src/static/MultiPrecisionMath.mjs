...
export class MultiPrecisionMath {
     ...
     * @param {string} int1 
     * @param {string} int2
     * @return {string} The sum of int1 and int2
     */
     ...
     * @return {string} The difference of largerInt and smallerInt
     */
     ...
     * @param {string} dec1 
     * @param {string} dec2
     * @return {string} The sum of dec1 and dec2
     */
     ...
     * @return {string} The difference of largerDec and smallerDec
     */
     ...
     * @return {string} The product of integer with multiplier
     */
     ...
     * @param {number} multiplier Must honor the range 0<=multiplier<=NUmber.MAX_SAFE_INTEGER/9
     * @return {string} The product of decimal with multiplier
     */
     ...
     * @param {string} int1 
     * @param {string} int2
     * @return {string} The product of int1 with int2
     */
     ...
     * @param {string} dec1
     * @param {string} dec2
     * @return {string} The product of dec1 with dec2
     */
     ...
     * @return {string} The sum of dec1 and dec2
     */
    static addDecWithBigInt(dec1, dec2) {
        const dec1Parts = dec1.split(".");
        const dec2Parts = dec2.split(".");
     ...
     * @param {string} dec1 
     * @param {string} dec2
     * @return {string} The product of dec1 and dec2
     */
    static multiplyDecWithBigInt(dec1, dec2) {
        const dec1Parts = dec1.split(".");
        const dec2Parts = dec2.split(".");
